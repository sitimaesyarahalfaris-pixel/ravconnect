            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="relative lg:h-[600px] hidden lg:block">
                    ...
                    <div class="absolute bottom-10 left-0 bg-white rounded-2xl p-6 shadow-2xl transform -rotate-6 hover:rotate-0 transition-all">
                            <div class="flex items-center gap-4">
                                <div class="w-16 h-16 bg-linear-to-br from-[#FFC50F] to-[#FFA500] rounded-xl flex items-center justify-center">
                        ...
                        <div class="absolute top-10 left-10 bg-linear-to-br from-[#FFC50F] to-[#FFD700] rounded-2xl p-5 shadow-2xl transform rotate-6 hover:rotate-0 transition-all">
